        ...
        <div class="content">
            ...
            <section id="about" class="container">
                        <div class="half">
                            ...
                            <h4 class="h1" style="color: #00BF62;"><strong>San Gelacio, Victoria, Philippines, 5205</strong></h4>
                            <p class="subtitle" >Address</p>
                            <h4 class="h2" style="color: #00BF62;"><strong>0919 228 4143</strong></h4>
                            <p class="subtitle">Mobile</p>
                            <h4 class="h3" style="color: #00BF62;"><strong>greenparkmemorialgarden@gmail.com</strong></h4>
                        ...
                        <div class="half">
                            ...
                            <p class="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Increasingly, families are pre-arranging for their cemetery needs.
                                Pre-need purchases allow the family to make important decisions at their convience
                                without the pressures of an emotional situation. It is important to have adequate time 
                                to absorb information and discuss it with the family and close friends. Pre-planning
                                for inevitable needs such as in-ground burials and memorialization is as essential 
                                as buying life insurance. Pre-arranged purchases help families who are prepared for the
                                future save money by securing the current price of lot.
                            </p>
                            <p class="justify">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Many purchasing families do not fully understand the 
                                costs involved in burial, entombment, cremation and memorialization
                                but preparing in advance can ease your emotional and financial burdens.
                                Making decisions on memorialization and purchasing property allows you and your loved ones to
                                rest assured that an informed and best decisions was made. Contact our office for more information
                                on pre-arranging your needs.
                            </p>
                        </div>
            </section>
            ...
            <section id="contacts" class="container">
                <div class="half">
                    ...
                    <img style="width: 20%;float: left; margin-right: 10px;" src="img/t1.png">
