...
class PayrollController extends Controller
{
    public function showPayroll()
    {
        $payrolls = Payroll::with(['payrollItems.member'])
            ->whereHas('payrollItems.member', function ($query) {
                $query->where('employment_status', 'permanent'); // Filter by 'permanent' employment status
            })
            ->get();
    ...
    public function store(Request $request)
    {
        ...
        // Fetch members who are verified and have employment status set to 'permanent'
        ...
        return redirect()->route('admin.payroll')->with('message', 'Payroll computed successfully.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('payroll.show')->with('success', 'Payroll deleted successfully.');
...
public function show($id)
{
    ...
    return view('admin.payroll_detail', compact('payroll'));
}
